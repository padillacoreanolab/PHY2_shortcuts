...
class ISIViolationPlugin1_5ms(IPlugin):
    def attach_to_controller(self, controller):
        ...
        def isi_violations(cluster_id):
            ...
            all_isi = np.diff(t)
            return len(all_isi[all_isi < 0.0015])
        ...
        # on disk).
        controller.cluster_metrics['1_5_ms_isi'] = controller.context.memcache(isi_violations)